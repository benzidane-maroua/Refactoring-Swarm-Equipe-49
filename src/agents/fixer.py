...
from src.tools.file_tools import read_file, write_file, list_python_files, extract_json
        ...
        try:
            ...
            log_experiment(
                ...
                details={
                    ...
                    "issues_found": state["audit_report"][counter]["issues_found"]
                },
                status="SUCCESS"
            )
            if fixed_code.strip():
                write_file(file_path, fixed_code_json["fixed_code"])
